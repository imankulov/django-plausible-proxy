...
Django Plausible Proxy could always use more documentation, whether as part of the
official Django Plausible Proxy docs, in docstrings, or even on the web in blog posts,
articles, and such.
